{
    ...
    'description': 'Brutalist Luxury Engineering website theme for FAME Builders.',
    'category': 'Theme/Corporate',
    'summary': 'FAME Builders, Brutalist, Luxury, Engineering, Corporate',
    'sequence': 120,
    'version': '2.1.0',
    'depends': ['website'],
    'data': [
    ...
    'images': [
        'static/description/clean_description.png',
        'static/description/clean_screenshot.png',
    ],
    'images_preview_theme': {
        'website.s_image_text_default_image': '/custom_theme/static/src/img/content/image_content_20.webp',
        'website.s_banner_default_image': '/custom_theme/static/src/img/backgrounds/bg_snippet_07.webp',
        'website.s_text_image_default_image': '/custom_theme/static/src/img/content/image_content_19.webp',
        'website.s_picture_default_image': '/custom_theme/static/src/img/content/image_content_21.webp',
    },
    ...
    'assets': {
        'website.assets_editor': [
            'custom_theme/static/src/js/tour.js',
        ],
    }
}
